/// Mirrors the backend's `UserSettings` document (`/settings` GET/PUT).
/// Cached locally in Hive under a single fixed key so it's available
/// instantly on cold start, even offline.
class AppSettings {
